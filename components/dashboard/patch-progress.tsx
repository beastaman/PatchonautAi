        ...
        >
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 sm:col-span-6 flex items-start space-x-3">
              <div className={`h-3 w-3 rounded-full mt-1.5 flex-shrink-0 ${patch.statusColor}`}></div>
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">ID: {patch.id}</p>
              </div>
            </div>
            ...
            <div className="col-span-6 sm:col-span-1 flex items-center">
              <div className="text-sm">
                <span className="text-muted-foreground">ETA:</span> {patch.eta}
              </div>
            </div>
            ...
            <div className="col-span-6 sm:col-span-2 flex items-center justify-end">
              <Button 
                size="sm" 
                variant={patch.status === 'Failed' ? 'destructive' : 'outline'}
                className="h-8"
              >
                <actionButtonMap[patch.status].icon className="h-3.5 w-3.5 mr-1.5" />
